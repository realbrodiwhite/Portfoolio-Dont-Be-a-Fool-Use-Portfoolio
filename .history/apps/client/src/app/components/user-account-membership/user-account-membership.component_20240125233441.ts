...
export class UserAccountMembershipComponent implements OnDestroy, OnInit {
  ...
  public trySubscriptionMail =
    'mailto:hi@ghostfol.io?Subject=Portfoolio Premium Trial&body=Hello%0D%0DI am interested in Portfoolio Premium. Can you please send me a coupon code to try it for some time?%0D%0DKind regards';
  public user: User;
