...
import { AuthDeviceDto } from '@portfoolio/api/app/auth-device/auth-device.dto';
import {
  PublicKeyCredentialCreationOptionsJSON,
  PublicKeyCredentialRequestOptionsJSON
} from '@portfoolio/api/app/auth/interfaces/simplewebauthn';
import { SettingsStorageService } from '@portfoolio/client/services/settings-storage.service';
import {
  startAuthentication,
  startRegistration
