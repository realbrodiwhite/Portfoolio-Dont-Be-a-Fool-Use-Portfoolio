...
const routes: Routes = [
  ...
  {
    canActivate: [AuthGuard],
    path: '2021/07/hallo-portfoolio',
    loadComponent: () =>
      import('./2021/07/hallo-portfoolio/hallo-portfoolio-page.component').then(
        (c) => c.HalloPortfoolioPageComponent
      ),
    title: 'Hallo Portfoolio'
  },
  {
    canActivate: [AuthGuard],
    path: '2021/07/hello-portfoolio',
    loadComponent: () =>
      import('./2021/07/hello-portfoolio/hello-portfoolio-page.component').then(
        (c) => c.HelloPortfoolioPageComponent
      ),
    title: 'Hello Portfoolio'
  },
  {
    canActivate: [AuthGuard],
    path: '2022/01/portfoolio-first-months-in-open-source',
    loadComponent: () =>
      import(
  ...
  {
    canActivate: [AuthGuard],
    path: '2022/07/portfoolio-meets-internet-identity',
    loadComponent: () =>
      import(
        './2022/07/portfoolio-meets-internet-identity/portfoolio-meets-internet-identity-page.component'
      ).then((c) => c.PortfoolioMeetsInternetIdentityPageComponent),
    title: 'Portfoolio meets Internet Identity'
  },
  {
    canActivate: [AuthGuard],
  ...
  {
    canActivate: [AuthGuard],
    path: '2023/01/portfoolio-auf-sackgeld-vorgestellt',
    loadComponent: () =>
      import(
        './2023/01/portfoolio-auf-sackgeld-vorgestellt/portfoolio-auf-sackgeld-vorgestellt-page.component'
      ).then((c) => c.PortfoolioAufSackgeldVorgestelltPageComponent),
    title: 'Portfoolio auf Sackgeld.com vorgestellt'
  },
  {
    canActivate: [AuthGuard],
    path: '2023/02/portfoolio-meets-umbrel',
    loadComponent: () =>
      import(
        './2023/02/portfoolio-meets-umbrel/portfoolio-meets-umbrel-page.component'
      ).then((c) => c.PortfoolioMeetsUmbrelPageComponent),
    title: 'Portfoolio meets Umbrel'
  },
  {
    canActivate: [AuthGuard],
    path: '2023/03/portfoolio-reaches-1000-stars-on-github',
    loadComponent: () =>
      import(
        './2023/03/1000-stars-on-github/1000-stars-on-github-page.component'
      ).then((c) => c.ThousandStarsOnGitHubPageComponent),
    title: 'Portfoolio reaches 1’000 Stars on GitHub'
  },
  {
    canActivate: [AuthGuard],
    path: '2023/05/unlock-your-financial-potential-with-portfoolio',
    loadComponent: () =>
      import(
        './2023/05/unlock-your-financial-potential-with-portfoolio/unlock-your-financial-potential-with-portfoolio-page.component'
      ).then((c) => c.UnlockYourFinancialPotentialWithPortfoolioPageComponent),
    title: 'Unlock your Financial Potential with Portfoolio'
  },
  {
    canActivate: [AuthGuard],
  ...
  {
    canActivate: [AuthGuard],
    path: '2023/08/portfoolio-joins-oss-friends',
    loadComponent: () =>
      import(
        './2023/08/portfoolio-joins-oss-friends/portfoolio-joins-oss-friends-page.component'
      ).then((c) => c.PortfoolioJoinsOssFriendsPageComponent),
    title: 'Portfoolio joins OSS Friends'
  },
  {
    canActivate: [AuthGuard],
    path: '2023/09/portfoolio-2',
    loadComponent: () =>
      import('./2023/09/portfoolio-2/portfoolio-2-page.component').then(
        (c) => c.Portfoolio2PageComponent
      ),
    title: 'Portfoolio 2.0'
  },
  {
    canActivate: [AuthGuard],
