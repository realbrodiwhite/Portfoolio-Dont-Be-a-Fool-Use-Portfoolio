...
import { IcsService } from '@portfoolio/client/services/ics/ics.service';
...
import { DEFAULT_PAGE_SIZE } from '@portfoolio/common/config';
import { downloadAsFile } from '@portfoolio/common/helper';
import { Filter, User } from '@portfoolio/common/interfaces';
  ...
  public onExport(activityIds?: string[]) {
    this.dataService
      ...
      .subscribe((data) => {
        ...
        downloadAsFile({
          content: data,
          fileName: `portfoolio-export-${format(
