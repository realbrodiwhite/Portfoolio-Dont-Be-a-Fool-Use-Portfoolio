...
import { GfAccountDetailDialogModule } from '@portfoolio/client/components/account-detail-dialog/account-detail-dialog.module';
import { GfAccountsTableModule } from '@portfoolio/client/components/accounts-table/accounts-table.module';
