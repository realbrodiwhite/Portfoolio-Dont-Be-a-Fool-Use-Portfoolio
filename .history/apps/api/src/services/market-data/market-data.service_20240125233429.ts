import { UpdateMarketDataDto } from '@portfoolio/api/app/admin/update-market-data.dto';
import { DateQuery } from '@portfoolio/api/app/portfolio/interfaces/date-query.interface';
