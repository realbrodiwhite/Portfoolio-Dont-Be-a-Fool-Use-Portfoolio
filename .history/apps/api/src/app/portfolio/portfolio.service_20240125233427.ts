...
import { CashDetails } from '@portfoolio/api/app/account/interfaces/cash-details.interface';
import { Activity } from '@portfoolio/api/app/order/interfaces/activities.interface';
import { OrderService } from '@portfoolio/api/app/order/order.service';
import { CurrentRateService } from '@portfoolio/api/app/portfolio/current-rate.service';
import { PortfolioOrder } from '@portfoolio/api/app/portfolio/interfaces/portfolio-order.interface';
import { TransactionPoint } from '@portfoolio/api/app/portfolio/interfaces/transaction-point.interface';
import { UserService } from '@portfoolio/api/app/user/user.service';
import { AccountClusterRiskCurrentInvestment } from '@portfoolio/api/models/rules/account-cluster-risk/current-investment';
import { AccountClusterRiskSingleAccount } from '@portfoolio/api/models/rules/account-cluster-risk/single-account';
import { CurrencyClusterRiskBaseCurrencyCurrentInvestment } from '@portfoolio/api/models/rules/currency-cluster-risk/base-currency-current-investment';
import { CurrencyClusterRiskCurrentInvestment } from '@portfoolio/api/models/rules/currency-cluster-risk/current-investment';
import { EmergencyFundSetup } from '@portfoolio/api/models/rules/emergency-fund/emergency-fund-setup';
import { FeeRatioInitialInvestment } from '@portfoolio/api/models/rules/fees/fee-ratio-initial-investment';
import { DataProviderService } from '@portfoolio/api/services/data-provider/data-provider.service';
...
import { DATE_FORMAT, getSum, parseDate } from '@portfoolio/common/helper';
import {
  Accounts,
...
import { InvestmentItem } from '@portfoolio/common/interfaces/investment-item.interface';
import type {
  AccountWithValue,
  DateRange,
  GroupBy,
