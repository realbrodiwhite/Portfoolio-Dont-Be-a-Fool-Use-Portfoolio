...
import { MarketDataService } from '@portfoolio/api/services/market-data/market-data.service';
...
jest.mock('@portfoolio/api/services/market-data/market-data.service', () => {
  return {
...
jest.mock(
  '@portfoolio/api/services/exchange-rate-data/exchange-rate-data.service',
  () => {
    return {
...
jest.mock('@portfoolio/api/services/property/property.service', () => {
  return {
