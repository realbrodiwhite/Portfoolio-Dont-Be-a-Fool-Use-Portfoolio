...
import { ExchangeRateDataServiceMock } from '@portfoolio/api/services/exchange-rate-data/exchange-rate-data.service.mock';
import { parseDate } from '@portfoolio/common/helper';
import Big from 'big.js';

import { CurrentRateServiceMock } from './current-rate.service.mock';
import { PortfolioCalculator } from './portfolio-calculator';

jest.mock('@portfoolio/api/app/portfolio/current-rate.service', () => {
  return {
