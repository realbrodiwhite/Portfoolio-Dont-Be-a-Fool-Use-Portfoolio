...
- Added `healthcheck` for the _Portfoolio_ service to the `docker-compose` files (`docker-compose.yml` and `docker-compose.build.yml`)
...
- Added a blog post: _Announcing Portfoolio 2.0_
...
- Added a blog post: _Portfoolio joins OSS Friends_
...
- Updated the URL of the Portfoolio Slack channel
- Removed the _Portfoolio in Numbers_ section from the about page
...
- Extended the footer navigation by the localized Portfoolio versions
- Improved the language localization for German (`de`)
...
- Added a blog post: _Unlock your Financial Potential with Portfoolio_
...
- Added a blog post: _Portfoolio reaches 1’000 Stars on GitHub_
...
- Fixed the feature graphic of the _Portfoolio meets Umbrel_ blog post

## 1.239.0 - 2023-02-25

### Added

- Added a blog post: _Portfoolio meets Umbrel_
...
- Removed the data source type `PORTFOOLIO`
...
- Eliminated the `PortfoolioScraperApiService`
...
- Copy the logic of `PortfoolioScraperApiService` to `ManualService`
...
- Rename the `dataSource` from `PORTFOOLIO` to `MANUAL`
- Eliminate `PortfoolioScraperApiService`
...
- Added a quote to the blog post _Portfoolio auf Sackgeld.com vorgestellt_
...
- Added a blog post: _Portfoolio auf Sackgeld.com vorgestellt_
...
- Set `NODE_ENV: production` as in [docker-compose.yml](https://github.com/portfoolio/portfoolio/blob/main/docker/docker-compose.yml)
...
- Added `PORTFOOLIO` as a default to `DATA_SOURCES`
...
- Added a blog post: _Portfoolio meets Internet Identity_
...
- Fixed the `No data provider has been found` error in the search (regression after `envalid` upgrade to `7.3.1` in Portfoolio `1.157.0`)
...
- Added the _Portfoolio_ trailer to the landing page
...
- Eliminated the circular dependencies in the `@portfoolio/common` library
...
- Reused the value component in the _Portfoolio in Numbers_ section of the about page
...
- Fixed the support for multiple symbols of the data source `PORTFOOLIO`
...
- Removed the prefix for symbols with the data source `PORTFOOLIO`
...
- Extended the documentation for self-hosting with the [official Portfoolio Docker image](https://hub.docker.com/r/portfoolio/portfoolio)
...
- Added the Portfoolio Slack channel to the about page
...
- Improved the style of the _Portfoolio in Numbers_ section

## 1.19.0 - 17.06.2021

### Added

- Added a _Portfoolio in Numbers_ section to the about page
...
- Renamed _Portfoolio Account_ to _My Portfoolio_
...
- Renamed shared helper to `@portfoolio/common/helper`
- Moved shared interfaces to `@portfoolio/common/interfaces`
- Moved shared types to `@portfoolio/common/types`
...
- Changed the _Portfoolio_ SaaS (cloud) from a `nano` to a `micro` instance for a better performance
...
- Improved the alignment of the _Why Portfoolio?_ section
...
- Extended the landing page text: _Portfoolio_ empowers busy folks...
...
- Extended the landing page text: Why _Portfoolio_?
...
- Added a landing page text: How does _Portfoolio_ work?
...
- Added a landing page text: Why _Portfoolio_?
