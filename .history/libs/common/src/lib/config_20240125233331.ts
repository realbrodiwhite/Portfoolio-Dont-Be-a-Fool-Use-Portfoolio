...
export const portfoolioPrefix = 'GF';
export const portfoolioScraperApiSymbolPrefix = `_${portfoolioPrefix}_`;
export const portfoolioCashSymbol = `${portfoolioScraperApiSymbolPrefix}CASH`;
export const portfoolioFearAndGreedIndexDataSource = DataSource.RAPID_API;
export const portfoolioFearAndGreedIndexSymbol = `${portfoolioScraperApiSymbolPrefix}FEAR_AND_GREED_INDEX`;
